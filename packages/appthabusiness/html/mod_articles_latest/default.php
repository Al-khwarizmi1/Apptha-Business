...
$doc->addScript(JURI::base() . "modules/mod_contus_bannerslider/js/jquery.cycle.min.js");
$doc->addScript(JURI::base() . "modules/mod_contus_bannerslider/js/jquery.cycle.all.min.js");
?>
<script type="text/javascript">
  jQuery.noConflict();
    jQuery(document).ready(function() {
        jQuery('.newsShow').after().cycle({
...
<div class="newsShow">
    <?php foreach ($list as $item) : ?>
        ...
        <?php echo "Top News: ".$item->title; ?></a>
    <?php endforeach; ?>
</div>
